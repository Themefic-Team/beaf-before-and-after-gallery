...
function bafg_before_after_method_conditional_field(){
    ...
    if (bafg_before_after_method == 'method_2') {
        ...
        jQuery('.bafg-row-before-image, .bafg-row-after-image, .bafg-row-first-image, .bafg-row-second-image, .bafg-row-third-image,.bafg-fade, .bafg_popup_preview,.bafg-skip-lazy-load').hide();

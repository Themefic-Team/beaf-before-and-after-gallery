			...
			<div class="other-document">
				...
				<div class="dropdown">
					<div class="list-item">
						...
						<span><?php _e("Need Help?","bafg"); ?></span>
						</a>
						<a href="https://themefic.com/docs/bafg/" target="_blank">
							...
							<span><?php _e("Documentation","bafg"); ?></span>
						...
						<a href="https://portal.themefic.com/support/" target="_blank">
							...
							<span><?php _e("Feature Request","bafg"); ?></span>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="tf-settings-help-center">
				<div class="tf-help-center-banner">
					<div class="tf-help-center-content">
						<h2><?php _e("Setup Wizard","bafg"); ?></h2>
						<p><?php _e("Click the button below to run the setup wizard of Tourfic. Your existing settings will not change.","bafg"); ?></p>
					...
					<div class="tf-accordion-wrapper">
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									...
									<h4><?php _e("What is Tourfic? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Tourfic is the ultimate WordPress travel plugin for hotel booking, tour operator and travel agency websites.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("How to install Tourfic? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Please check our documentations","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("Is Free version fully free or there is a gap? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Yes, Tourfic is fully free which is available on WordPress.org. This free version will always be free. It also has a pro version with additional features which you can purchase from our official website.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("Can I create a hotel booking website with Tourfic? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Yes, You create your own professional hotel booking website easily with bafg.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("Can I create a travel or tour booking website with Tourfic? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Yes, You create your own professional travel or tour booking website easily with bafg.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("Can Tourfic be used as WooCommerce Accommodation Bookings? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Yes, You create your own professional accommodation booking website easily with bafg.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("Can I create a website similar to Booking.com with Tourfic? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Yes, You can create your own professional tour operator and travel agency website within 5 minutes, just like Booking.com, Agoda, Hotels.com, Airbnb etc.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
						<div class="tf-accrodian-item">
							<div class="tf-single-faq">
								<div class="tf-faq-title">
									<i class="fas fa-angle-down"></i>
									<h4><?php _e("Is free version supported? ","bafg"); ?></h4>
								</div>
								<div class="tf-faq-desc">
									<p>
									<?php _e("Yes, We provide full support on the WordPress.org forums. You can also post questions or bug reports through our Facebook group! or our website. However, please note that, for free version’s support/replies, there can be delays upto 24-48 hours.","bafg"); ?>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="tf-setting-license-field">
					<div class="tf-tab-wrapper">
						<div id="license" class="tf-tab-content">
							...
							if ( TourficProBase::CheckWPPlugin( $licenseKey, $liceEmail, $licenseMessage, $responseObj, TF_PRO_PATH . 'bafg-pro.php' ) ) {
								tf_license_info();
							} else {
							?>
							<div class="tf-field tf-field-text" style="width: 100%;">
								<label for="tf_settings[license-key]" class="tf-field-label"> <?php _e("License Key","bafg"); ?></label>

								<span class="tf-field-sub-title"><?php _e("Enter your license key here, to activate the product, and get full feature updates and premium support.","bafg"); ?></span>
							...
							<div class="tf-field tf-field-text" style="width: 100%;">
								<label for="tf_settings[license-email]" class="tf-field-label"> <?php _e("License Email ","bafg"); ?></label>

								<span class="tf-field-sub-title"><?php _e("We will send update news of this product by this email address, don't worry, we hate spam","bafg"); ?></span>
                            ...
                            <div class="tf-tab-wrapper">
								...
								foreach ( $this->option_sections as $key => $section ) : ?>
									...
									<div class="tf-option-footer">
										<button type="submit" class="tf-admin-btn tf-btn-secondary tf-submit-btn"><?php _e( 'Save', 'bafg' ); ?></button>
									</div>
                            </div>
                        </div>

            ...
            <div class="wd-dr-modal-wrap">
                ...
                <div class="wd-dr-modal-body">
                    ...
                    <p class="wd-dr-modal-reasons-bottom">
                        <?php
                        echo sprintf(
                            esc_attr($this->client->__trans( 'We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Appsero handles your data.' )),
                ...
                <div class="wd-dr-modal-footer">
                    <a href="#" class="dont-bother-me wd-dr-button-secondary"><?php esc_html($this->client->_etrans( 'Skip & Deactivate' )); ?></a>
                    <button class="wd-dr-button-secondary wd-dr-cancel-modal"><?php esc_html($this->client->_etrans( 'Cancel' )); ?></button>
                    <button class="wd-dr-submit-modal"><?php esc_html($this->client->_etrans( 'Submit & Deactivate' )); ?></button>
                </div>
            </div>
        </div>
